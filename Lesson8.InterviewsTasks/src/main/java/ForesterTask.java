...
public class ForesterTask {
    public static void main(String[] args) {
        Map<Integer, Integer> foresterNotebook = new HashMap<Integer, Integer>();
        ...
        for (String tree : trees) {
            Integer treeCode = Integer.parseInt(tree);
            foresterNotebook.put(treeCode, foresterNotebook.getOrDefault(treeCode, 0) + 1);
        }
