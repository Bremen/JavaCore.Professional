...
public class ForesterTask2{
    private static final int TREE_TYPE_COUNT = 5;
    public static void main(String[] args) {
        ArrayList<Integer> foresterNotebook = new ArrayList<>(Collections.nCopies(TREE_TYPE_COUNT, 0));

        String forest = "5 1 5 2 2 4 1 4 5 1 5 3 2 4 4 4 5 1 3 4 2 2 1 2 4 4 4 5 4 3 5 4 4 5 5 1 4 1 5 3 1 4 5 3 3 4 2 2 4 4 5 5 1 1 1 4 5 5\n" +
        ...
        String[] trees = forest.replace("\n", "").split(" ");

        //Обход леса
        for (String tree : trees) {
            int treeCode = Integer.parseInt(tree) - 1;
            foresterNotebook.set(treeCode, foresterNotebook.get(treeCode)+1);
        }

        System.out.println(foresterNotebook);
    }
}
